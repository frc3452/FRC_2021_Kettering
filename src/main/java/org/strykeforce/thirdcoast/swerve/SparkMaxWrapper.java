...
public class SparkMaxWrapper implements MotorControllerWrapper {
  ...
  public SparkMaxWrapper(MotorControllerConfig config, int id) {
    ...
    sparkMax = new CANSparkMax(id + 1, getRevMotorType(config.motorType));
    ...
    if (feedbackSensor == FeedbackSensor.INTEGRATED_SENSOR) {
      ...
      remoteSensor = true;
      encoder = new CANCoder(id + 21);
      encoder.configFactoryDefault();
      encoder.configFeedbackCoefficient(1.0, "deg", SensorTimeBase.PerSecond);
